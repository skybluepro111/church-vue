<template>
  ...
  <div class="sunday-morning-single" id = "printableArea">
    ...
    <div class="page" v-if="item">
      <div class="half-page" >
        <div class="header">
          <h2><span v-if="item.fields.Service_Type == 'Sunday AM'">AM</span><span v-if="item.fields.Service_Type == 'Sunday PM'">PM</span><span v-if="item.fields.Service_Type == 'Midweek'">Midweek</span> Order of Service</h2>
